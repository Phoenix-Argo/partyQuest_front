<template>
  <div class="d-flex dropdown">
    <div class="dropdown-toggle" id="head" data-bs-toggle="dropdown" aria-expanded="false">{{member.nickName}}</div>
    <ul class="dropdown-menu" aria-labelledby="head">
      <li v-for="menu in authMenu" class="dropdown-item">
        {{menu}}
      </li>
      <li class="dropdown-divider"><hr></li>
      <li><button class="dropdown-item" @click="onClickHandler">로그아웃</button></li>
    </ul>
  </div>
</template>
